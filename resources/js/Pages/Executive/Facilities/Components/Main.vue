                        ...
                        <div class="carousel-content">
                            <transition mode="out-in">
                                <div :key="index" class="tab-content">
                                    <Signatories :code="facility.code" v-if="menu == 'Signatories'"/>
                                    <Users :code="facility.code" v-if="menu == 'Users'"/>
                                    <Laboratories :code="facility.code" v-if="menu == 'Laboratories'"/>
                                </div>
                            </transition>
                        </div>
                    </div>
...
export default {
    components: { simplebar, Users, Laboratories, Signatories },
    props: ['facility','dropdowns'],
    data(){
        return {
            menus: [
                'Overview','Signatories','Users','Laboratories'
            ],
            index: null,
        }
    },
