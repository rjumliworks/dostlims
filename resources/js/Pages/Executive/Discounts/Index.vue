<template>
    ...
    <PageHeader title="Discount Management" pageTitle="List" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">List of Discounts</span></h5>
                        ...
                        <table class="table align-middle table-striped table-centered mb-0">
                            <thead class="table-light thead-fixed">
                                <tr class="fs-11">
                                    ...
                                    <th style="width: 10%;" class="text-center">Base</th>
                                        ...
                                        <div class="d-flex gap-3 justify-content-center"> 
                                            <div class="dropdown">
                                                <BDropdown variant="link" toggle-class="btn btn-light btn-sm dropdown" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }"> 
                                                    ...
                                                    <li>
                                                        <a @click="openActivation(list,index)" class="dropdown-item d-flex align-items-center" :class="(list.is_active) ? 'text-danger' : 'text-success'" href="#removeFileItemModal" data-id="1" data-bs-toggle="modal" role="button">
                                                            <span v-if="list.is_active"><i class="ri-lock-2-fill me-2"></i> Deactivate Status</span>
                                                            <span v-else><i class="ri-lock-unlock-line me-2"></i> Activate Status</span>
                                                        </a>
                                                    </li>
                                                </BDropdown>
                                            </div>
